...
export const CandlestickChart: React.FC<CandlestickChartProps> = ({ 
    ...
    useEffect(() => {
        ...
        const resizeObserver = new ResizeObserver(entries => {
            if (chartRef.current && chartContainerRef.current && entries.length) {
                         ...
                         <h3 className="font-display font-bold text-white text-[10px] tracking-[0.2em] uppercase flex items-center gap-2">
                            ...
                            {isLive && (
                                <span className="flex items-center gap-1.5 ml-2">
                                    ...
                                    <span className="text-[9px] font-black text-emerald-500 tracking-tighter">LIVE</span>
                                </span>
                            )}
                         </h3>
                    </div>
