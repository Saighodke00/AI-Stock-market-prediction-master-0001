...
export const TickerMetadataCard: React.FC<TickerMetadataProps> = ({ meta, isLoading }) => {
  ...
  if (isLoading) {
    return (
      <div className="bg-[#0a0f1d] border border-white/5 rounded-xl p-5 animate-pulse">
  ...
  return (
    <div className="bg-[#0a0f1d] border border-white/5 rounded-xl p-5 shadow-2xl relative overflow-hidden group">
      {/* Background Accent */}
      ...
      <div className="flex items-center gap-2 mb-6">
        ...
        <h3 className="text-[10px] font-black text-slate-500 uppercase tracking-[0.2em]">Ticker Intelligence</h3>
      </div>
      ...
      <div className="space-y-5 relative z-10">
        <div className="flex flex-col gap-1 border-b border-white/[0.03] pb-4">
          ...
          <div className="flex items-center justify-between">
            <span className="text-[9px] font-medium text-slate-500 lowercase ml-4">{meta?.industry || 'Unknown Industry'}</span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 gap-4">
          <div className="flex items-center justify-between">
            ...
            <div className="text-right flex flex-col gap-1">
              <span className="text-[10px] font-bold text-slate-600 uppercase tracking-widest flex items-center gap-1.5 justify-end">
        ...
        {/* Status indicator */}
        <div className="pt-2">
            <div className="text-[9px] font-mono text-slate-500 bg-white/[0.03] border border-white/5 rounded-md px-3 py-1.5 flex items-center gap-2">
