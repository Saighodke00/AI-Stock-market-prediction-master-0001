    ...
    return (
        <div className="neon-frame rounded-3xl p-6 shadow-2xl relative overflow-hidden group">
            ...
            <div className="flex justify-between items-center mb-8">
                ...
                <div className={`p-2.5 rounded-xl bg-void/50 border border-white/5 ${isProfit ? 'text-emerald glow-emerald' : 'text-rose glow-rose'}`}>
                    <Activity size={18} />
                </div>
            </div>
            ...
            <div className="flex flex-col gap-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                    <div className="bg-void/40 p-4 rounded-2xl border border-white/5 group-hover:border-white/10 transition-colors">
