...
export const TradeArchitect: React.FC = () => {
    return (
        <div className="mx-10 mt-6 group cursor-pointer transition-all duration-500">
            <div className="flex items-center justify-between px-6 py-4 bg-surface/30 backdrop-blur-md border border-white/5 rounded-2xl hover:bg-surface/50 hover:border-white/10 transition-all shadow-2xl">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <ChevronRight className="w-5 h-5 text-slate-500 group-hover:text-white transition-colors group-hover:translate-x-1 duration-500" />
                </div>
            </div>
        </div>
    );
