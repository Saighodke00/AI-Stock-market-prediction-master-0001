      ...
      <div className="max-w-md w-full bg-[#111827] rounded-xl border border-[#1f2937] p-8 shadow-2xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <button 
            type="submit" 
            disabled={loading}
            className="w-full py-3 px-4 bg-blue-600 hover:bg-blue-500 text-white font-medium rounded-lg shadow-[0_0_15px_rgba(37,99,235,0.3)] transition-all disabled:opacity-50"
          >
