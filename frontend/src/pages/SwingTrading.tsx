                    ...
                    {loading ? (
                        ...
                        <div className="flex flex-col gap-6 max-w-[1400px] mx-auto">
                            ...
                            <div className="flex flex-col gap-5 mb-6 px-1">
                                ...
                                <div className="flex flex-wrap items-center gap-4 mt-2">
                                    <div className="flex items-center gap-2 shrink-0">
                                        ...
                                        <span className="text-[9px] font-black text-slate-600 uppercase tracking-widest whitespace-nowrap">Swing Horizon:</span>
                                    </div>
                                    <div className="flex flex-wrap bg-white/[0.03] border border-white/10 rounded-2xl p-1.5 backdrop-blur-md gap-1">
                                        {['1D', '1W'].map(t => (
                                            <button
                                                key={t}
                                                onClick={() => setTf(t)}
                                                className={`px-8 py-2 font-display text-[10px] font-black tracking-widest rounded-xl transition-all duration-300 uppercase shrink-0 ${tf === t ? 'bg-indigo-500 text-white shadow-[0_0_20px_rgba(99,102,241,0.4)]' : 'text-slate-500 hover:text-white hover:bg-white/5'}`}
                                            >
                                                {t}
                                            </button>
                                        ))}
                            ...
                            <div className="grid grid-cols-1 gap-6">
                                <NeuralSignalHeader data={signal} mode="swing" />
